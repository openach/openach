...
class OAIATFourthAddendaRecord extends OAIATAddendaRecord
{
	const ADDENDA_TYPE_CODE = '13';
	...
	protected function initRecordFields()
	{
		...
		$this->addField(
			array(
				new ODDataFieldName( 'ach_entry_iat_originating_dfi_name' ),
		...
		$this->addField(
			array(
				new ODDataFieldName( 'ach_entry_iat_originating_dfi_id_qualifier' ),
		...
		$this->addField(
			array(
				new ODDataFieldName( 'ach_entry_iat_originating_dfi_id' ),
		...
		$this->addField(
			array(
				new ODDataFieldName( 'ach_entry_iat_originating_dfi_country_code' ),
