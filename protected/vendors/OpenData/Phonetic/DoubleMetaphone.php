 ...
 * Copyright (C) 2001 Stephen Woodbridge, ALL RIGHTS RESERVED 
 *     woodbri@swoodbridge.com, http://swoodbridge.com/DoubleMetaPhone/
 * 
 * Refer to /legal/license.txt for license information, or view the full license
 * online at http://openach.com/community/license.txt
 ********************************************************************************/

#namespace openach\opendata\phonetic;
...
//
// 29-Jun-2017 Steven Brendtro http://www.openach.com
// Modification: Added flag to turn on/off 4-character limit for 
// hashes.  One version of DoubleMetaphone - specifically the one that 
// ended up as the basis for PECL doublemetaphone extension - did not
// have this limit.  In order to maintain compatibility with the two
// different variants, this modification allows the limit to be turned
// on and off.  By default, the limit is now disabled.  Pass a boolean
// true as the second parameter in the constructor to enable the limit.
//
// ------------------------------------------------------------------
class DoubleMetaphone
{
  ...
  public function __construct($string,$limit=false)
  {
    $this->primary = "";
    $this->secondary = "";
    $this->current = 0;
    ...
    while ( !$limit || strlen($this->primary) < 4 || strlen($this->secondary) < 4) {
