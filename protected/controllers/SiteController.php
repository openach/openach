...
class SiteController extends OAController
{
	...
	public function actionDemo()
	{
		...
		$randomNames = new Businesses();
		$names = $randomNames->getNames();
		asort( $names );
		$businesses = array_combine( $names, $names );
